...
# La opción "#| include: false" ejecuta el código, pero no muestra el código ni da como resultado el documento final.
# "#| message: false", y "#| warning: false" previenen que se impriman los mensajes de alerta en el documento exportado.
...
# Aplico la función.
# Si van a usar otro paquete deben indicarlo aquí.

load_pkgs(c("tidyverse", # Paquete para manipulación de datos
            "lavaan", # Paquete para análisis SEM
            "papaja", # Facilita la impresión del reporte y resultados en formato APA
            "semPlot", # Diagramar las salidas de lavaan
            "psych", # Bases de datos y Diversos métodos para el análisis
            "psychTools", # Acceso a bases de datos
...
# La opción #| echo está seteada en "false", lo que significa que el código se ejecutara pero no se mostrará en el documento final (sí se imprimirá el resultado).
